...
export const metadata: Metadata = {
  title: 'Alien Dawn - Realistic Platforming for Adults',
  description: 'A realistic, modern-day platformer featuring compelling characters with morally gray aspects. Dive into a mature narrative where your choices matter.',
  generator: 'v0.app',
  icons: {
    icon: [
      {
...
export default function RootLayout({
  ...
  var TOKEN="e4653091-1b87-4655-a85e-1a85bd5ff7e3821712790f747bf004d6539bc97a2bc2";
